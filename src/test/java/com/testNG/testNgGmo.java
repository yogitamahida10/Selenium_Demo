...
public void EnterGMOOnlineExternalframebackpack() {
	...
	//Assert.assertEquals(Entercatalogtitile, "OnLine Catalo");//Hard code Assertion: stop execution immediately
	
	SoftAssert objofSoftAssert=new SoftAssert();
	objofSoftAssert.assertEquals(Entercatalogtitile,"OnLine Catalo");// softAssertion: continue the execution even after assertion failed.
	
	driver.findElement(By.name("QTY_BACKPACKS")).sendKeys("5");
	//driver.findElement(By.xpath("//input[@value='Place An Order']")).click();//Relative path
	driver.findElement(By.xpath("/html[1]/body[1]/form[1]/table[1]/tbody[1]/tr[3]/td[1]/div[1]/center[1]/table[1]/tbody[1]/tr[1]/td[1]/p[1]/input[2]")).click();// Absolute path
